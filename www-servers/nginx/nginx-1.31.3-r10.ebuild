...
HTTP_VHOST_TRAFFIC_STATUS_MODULE_PV="0.2.6"
# HTTP_VHOST_TRAFFIC_STATUS_MODULE_SHA="c3dc4ab2da56ab389d0ce2a6adc1b71b664d6270"
...
# DEPRECATED: use lua module. Will be removed when will cause compilation fails
...
HTTP_PASSENGER_MODULE_PV="6.1.8"
...
HTTP_HEADERS_MORE_MODULE_PV="0.40"
...
HTTP_ENCRYPTED_SESSION_MODULE_PV="0.10"
...
HTTP_CACHE_PURGE_MODULE_PV="3.0.2"
...
STREAM_LUA_MODULE_PV="0.0.20rc2"
# STREAM_LUA_MODULE_SHA="9c205ed0f3f0033e94879ef1fd98f950ca896440"
...
HTTP_XSS_MODULE_URI="https://github.com/${HTTP_XSS_MODULE_A}/${HTTP_XSS_MODULE_PN}/archive/${HTTP_XSS_MODULE_SHA:-${HTTP_XSS_MODULE_PV}}.tar.gz"
...
HTTP_LUA_UPSTREAM_MODULE_PV="0.08"
...
HTTP_FANCYINDEX_MODULE_PV="0.6.0"
...
# acme-module (https://github.com/nginx/nginx-acme/tags, Apache-2)
...
# NJS-module (https://github.com/nginx/njs/tags, BSD-2)
HTTP_JAVASCRIPT_MODULE_A="nginx"
HTTP_JAVASCRIPT_MODULE_PN="njs"
HTTP_JAVASCRIPT_MODULE_PV="1.0.0"
...
### /QA
	...
	if use nginx_modules_http_rrd; then
### QA
...
# http_cache_purge
	if use nginx_modules_http_cache_purge; then
		...
		dodoc "${HTTP_CACHE_PURGE_MODULE_WD}"/README.md
	fi
