...
HTTP_AUTH_PAM_MODULE_WD="../${HTTP_AUTH_PAM_MODULE_P}"
...
HTTP_STICKY_MODULE_URI="https://bitbucket.org/nginx-goodies/${HTTP_STICKY_MODULE_PN}/get/${HTTP_STICKY_MODULE_PV}.tar.gz"
HTTP_STICKY_MODULE_WD="../${HTTP_STICKY_MODULE_PN}-${HTTP_STICKY_MODULE_PV_SHA}"
...
HTTP_AJP_MODULE_WD="../${HTTP_AJP_MODULE_P}"
...
HTTP_MOGILEFS_MODULE_WD="../${HTTP_MOGILEFS_MODULE_P}"
