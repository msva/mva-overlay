...
inherit autotools eutils gnome2 kde4-base cmake-utils

MAGIC="2865"

DESCRIPTION="SFLphone is a robust standards-compliant enterprise softphone, for desktop and embedded systems."
HOMEPAGE="http://www.sflphone.org/"
SRC_URI="https://projects.savoirfairelinux.com/attachments/download/${MAGIC}/${P}.tar.gz"
LICENSE="GPL-3"
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="debug doxygen gnome gsm networkmanager speex static-libs iax kde cli"
...
src_configure() {
	...
	econf --disable-dependency-tracking $(use_with debug) \
		$(use_with gsm) $(use_with networkmanager) $(use_with speex) $(use_enable static-libs static) $(use_enable doxygen) $(use_with iax iax2) $(use_with celt)
}
