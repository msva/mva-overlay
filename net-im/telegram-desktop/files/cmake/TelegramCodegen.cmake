...
add_custom_command(
	...
	COMMAND python ${TELEGRAM_SOURCES_DIR}/codegen/scheme/codegen_scheme.py -o${GENERATED_DIR} ${TELEGRAM_RESOURCES_DIR}/tl/mtproto.tl ${TELEGRAM_RESOURCES_DIR}/tl/api.tl
	DEPENDS ${CMAKE_SOURCE_DIR}/Resources/tl/mtproto.tl ${CMAKE_SOURCE_DIR}/Resources/tl/api.tl
	COMMENT "Codegen *.tl"
)
